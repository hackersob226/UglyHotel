...
public class RevenueReportPanel extends JPanel {
    ...
    public RevenueReportPanel() {
        ...
        String[] col = {"Month", "Location", "Total Revenue"};
    ...
    public void getData(Connection con, String dbName) throws SQLException {
        ...
        Statement stmt = null;
        String query = "SELECT MONTHNAME(RESERVATION.StartDate), RESERVATIONHASROOM.Location, SUM(RESERVATION.TotalCost) FROM RESERVATION INNER JOIN RESERVATIONHASROOM ON RESERVATION.ReservationID = RESERVATIONHASROOM.ReservationID WHERE RESERVATION.IsCancelled=0 AND MONTHNAME(RESERVATION.StartDate) = \"" + august+ "\" OR MONTHNAME(RESERVATION.StartDate) = \"" + sept+ "\" GROUP BY MONTHNAME(StartDate), Location";
        ...
        try {
            ...
            while(rs.next())
            {
                ...
                numList.add(rs.getInt("SUM(RESERVATION.TotalCost)"));
            }
